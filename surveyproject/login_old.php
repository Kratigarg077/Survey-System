...
if (isset($_POST['login'])) {
  ...
  if (mysqli_num_rows($data1) > 0) {
    // $_SESSION['adminname'] = $email_pass['admin_name'];
    ...
    if (mysqli_num_rows($data2) > 0) {
      ...
      unset($_SESSION['user_pass_reset']);
    ...
    <div class="container-fluid h-custom">
      <div class="row d-flex justify-content-center align-items-center h-100">
        ...
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1" style="margin-top:10%;">
          ...
          <?php 
          if (@$_SESSION['pass_reset']==1 || @$_SESSION['user_pass_reset']==1){
          ?>
          <p style="color:red;">Password changed successfully!! Please Login Again</p>
          <?php
          }
          ?>
            <!-- Email input -->
